...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        companyAC.setAccountHolderName("IT Software Limited");
        ...
        bank11.setAccountHolderName("Hassan Ohid");
        ...
        bank21.setAccountHolderName("Asikur Rahman Nisad");
        ...
        bank31.setAccountHolderName("Asikur Rahman");
        ...
        bank32.setAccountHolderName("Asikur");
        ...
        bank41.setAccountHolderName("Hassan");
        ...
        bank42.setAccountHolderName("Asikur Nisad");
        ...
        bank51.setAccountHolderName("Nisad Rahman");
        ...
        bank52.setAccountHolderName("Asik");
        ...
        bank61.setAccountHolderName("Moniruzzaman Rony");
        ...
        bank62.setAccountHolderName("Moniruzzaman");
